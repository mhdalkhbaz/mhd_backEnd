...
using ShamiCafe.Models.TokenAuth;
...
{
    public abstract class ShamiCafeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShamiCafeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShamiCafeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ShamiCafeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ShamiCafeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShamiCafeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShamiCafeDbContext, Task<T>> func)
        {
            T result;
